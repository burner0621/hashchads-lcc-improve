...
// sections
import { ProductTableRow, ProductTableToolbar } from '../../../sections/@hashchads/e-commerce/product-list';
...
export default function EcommerceProductList() {
  ...
  const handleEditRow = (id) => {
    push(PATH_HASHCHADS.eCommerce.edit(paramCase(id)));
  };
    ...
    <Page title="Ecommerce: Product List">
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          action={
            <NextLink href={PATH_HASHCHADS.eCommerce.new} passHref>
