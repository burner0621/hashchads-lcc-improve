                    ...
                    <ContentWrapper style={{ margin: "auto" }} className="px-2 sm:px-4">
                        ...
                        <div className="flex flex-col md:flex-row gap-2">
                            <div className="w-full md:w-9/12 mb-5" style={{ marginBottom: '20px' }}>
                                {
                                    isMobile &&
                                    <div id="moreDropdown" className={showMorePanel + " z-[100] bg-transparent divide-y divide-gray-100 rounded-lg shadow right-0"} >
                                                    ...
                                                    <CardBody>
                                                        <div className="flex flex-col">
                                                            ...
                                                            <Row className="flex justify-between mb-[10px]" >
                                                                ...
                                                                <span className="w-auto font-medium text-white text-right"><a target="_blank" rel="noreferrer" href={`https://hbarwhales.com/token/${address}`}>Check on Hbarwhales</a></span>
                                                            </Row>
                                                            <Row className="flex justify-between mb-[10px]" >
                                                            ...
                                                            <Row className="flex justify-between mb-[10px]">
                                                                <span className="w-auto font-medium text-white">Token ID:</span>
                                                                <span className="w-auto font-medium text-white text-right">
                                                                    <a href={'https://hashscan.io/mainnet/token/' + address} >
                                                                        {address}
                                                                    </a>
                                                                </span>
                                                            </Row>
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <Row className="flex justify-between mb-[10px]">
                                                        ...
                                                        <span className="w-auto font-medium text-right">
                                                            <a className="text-blue-500 hover:text-gray-300" href={'https://hashscan.io/mainnet/token/' + address} >
                                                                {address}
                                                            </a>
                                                        </span>
                                                    </Row>
